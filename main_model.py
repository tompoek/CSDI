...
class CSDI_Traj_Imputation(CSDI_base):
    def __init__(self, config, device, target_dim=3):
        super(CSDI_Traj_Imputation, self).__init__(target_dim, config, device)
...
class CSDI_Traj_Forecasting(CSDI_base):
    def __init__(self, config, device, target_dim=3):
        super(CSDI_Traj_Forecasting, self).__init__(target_dim, config, device)
        self.target_dim_base = target_dim
        self.num_sample_features = config["model"]["num_sample_features"]
